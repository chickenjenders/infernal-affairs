...
@onready var change_pw_panel: Panel = $ChangePW
@onready var update_button: Button = $ChangePW/Button

var current_requirement_index: int = 0
var requirements: Array[Node] = []
var elapsed_time = 0

var popchase_sound = preload("res://assets/sounds/popchase.ogg")
...
func _on_update_pressed() -> void:
	change_pw_panel.visible = false
	AudioManager.play_music(popchase_sound)
